...
(define-fun conflicts ((p1 Pkg) (p2 Pkg)) Bool
(forall ((t Time)) (and (=> (installed p1 t) (not (or (installed p2 (+ t 1)) (installed p2 t) (installed p2 (- t 1)))))
                        (=> (installed p2 t) (not (or (installed p1 (+ t 1)) (installed p1 t) (installed p1 (- t 1))))))))
